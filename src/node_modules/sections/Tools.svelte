...
<!--   <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-green-400">
  ...
  <!-- Brush -->
  <button on:click={ setTool('brush') } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-400 { tool.name == 'brush' && 'border-green-400 text-gray-700' }">
  ...
  <!-- Rectangle -->
  <button on:click={ setTool('rectangle') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-400 { tool.name == 'rectangle' && 'border-green-400 text-gray-700' }">
