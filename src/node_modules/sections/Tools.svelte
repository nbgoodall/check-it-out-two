...
<!--
  <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-green-400">
    <svg class="fill-current text-gray-700 w-5 h-5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <button class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2">
    <svg class="fill-current text-gray-800 w-5 h-5" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
