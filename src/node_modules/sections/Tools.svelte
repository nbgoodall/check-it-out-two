...
<div class="flex flex-col justify-between h-full">
  <div class="flex flex-col">
    ...
    <!-- Pointer -->
    <button on:click|stopPropagation={ () => $store.tool = 'pointer' } class="bg-white h-8 w-8 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'pointer' && 'border-green-400' }">
    ...
    <!-- Brush -->
    <button on:click|stopPropagation={ () => $store.tool = 'brush' } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'brush' && 'border-green-400' }">
   ...
   <!--  <button on:click|stopPropagation={ () => $store.tool = 'text' } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'text' && 'border-green-400 text-gray-900' }">
      <svg class="fill-current w-5 h-5 { tool.name != 'text' && 'opacity-50' }" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M60 10H40V30H60V10Z" />
        <path d="M80 110H60V130H80V110Z" />
        <path d="M120 10H100V30H120V10Z" />
        <path d="M40 10H20V30H40V10Z" />
        <path d="M80 90H60V110H80V90Z" />
        <path d="M80 70H60V90H80V70Z" />
        <path d="M80 50H60V70H80V50Z" />
        <path d="M80 30H60V50H80V30Z" />
        <path d="M100 10H80V30H100V10Z" />
        <path d="M80 10H60V30H80V10Z" />
      </svg>
  ...
  <div>
    <!-- Eraser -->
    {#if tool.eraseable }
      <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-gray text-gray-900 { $store.eraseModifier && 'border-gray-400' }">
        <svg class="fill-current w-5 h-5 { !$store.eraseModifier && 'opacity-50' }" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M30 100.124H50V120.124H30V100.124Z" fill="#AAAAAA"/>
          <path d="M10 100.124H30V120.124H10V100.124Z" fill="#AAAAAA"/>
          <path d="M10 80.124H30V100.124H10V80.124Z" fill="black"/>
          <path d="M50 100.124H70V120.124H50V100.124Z" fill="#AAAAAA"/>
          <path d="M50 80.124H70V100.124H50V80.124Z" fill="black"/>
          <path d="M70 80.124H90V100.124H70V80.124Z" fill="black"/>
          <path d="M30 80.124H50V100.124H30V80.124Z" fill="black"/>
          <path d="M70 60.124H90V80.124H70V60.124Z" fill="black"/>
          <path d="M50 60.124H70V80.124H50V60.124Z" fill="black"/>
          <path d="M50 40.124H70V60.124H50V40.124Z" fill="black"/>
          <path d="M90 60.124H110V80.124H90V60.124Z" fill="black"/>
          <path d="M90 40.124H110V60.124H90V40.124Z" fill="black"/>
          <path d="M30 60.124H50V80.124H30V60.124Z" fill="black"/>
          <path d="M110 40.124H130V60.124H110V40.124Z" fill="black"/>
          <path d="M70 40.124H90V60.124H70V40.124Z" fill="black"/>
          <path d="M110 20.124H130V40.124H110V20.124Z" fill="black"/>
          <path d="M90 20.124H110V40.124H90V20.124Z" fill="black"/>
          <path d="M70 20.124H90V40.124H70V20.124Z" fill="black"/>
        </svg>
      </button>
    {/if}
  </div>
