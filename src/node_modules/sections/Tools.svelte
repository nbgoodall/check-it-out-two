...
<div class="flex flex-col items-end">
  ...
  <!-- Eraser -->
  <button on:click|stopPropagation={ () => $store.tool = 'eraser' } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'eraser' && 'border-green-400' }">
    <svg class="fill-current w-5 h-5 { tool.name != 'eraser' && 'opacity-50' }" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
