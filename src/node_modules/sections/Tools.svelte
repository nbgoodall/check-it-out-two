...
<!--   <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-green-400">
  ...
  <button on:click|stopPropagation={ setTool('pointer') } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'pointer' && 'border-green-400' }">
  ...
  <!-- Brush -->
  <button on:click|stopPropagation={ setTool('brush') } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'brush' && 'border-green-400' }">
  ...
  <!-- Rectangle -->
  <button on:click|stopPropagation={ setTool('rectangle') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'rectangle' && 'border-green-400' }">
  ...
  <button on:click|stopPropagation={ setTool('fill') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'fill' && 'border-green-400 text-gray-900' }">
  ...
  <button on:click|stopPropagation={ setTool('line') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-500 { tool.name == 'line' && 'border-green-400 text-gray-900' }">
  ...
  <button on:click|stopPropagation={ setTool('ellipse') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-500 { tool.name == 'ellipse' && 'border-green-400 text-gray-900' }">
   <svg class="fill-current w-5 h-5" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
