...
<!--   <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-green-400">
  ...
  <button on:click={ setTool('pointer') } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'pointer' && 'border-green-400' }">
  ...
  <button on:click={ setTool('fill') } class="bg-white h-8 w-8 mt-2 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'fill' && 'border-green-400 text-gray-900' }">
