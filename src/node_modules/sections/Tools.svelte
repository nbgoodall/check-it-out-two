...
<!--   <button class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 border-green-400">
  ...
  <button on:click={ setTool('brush') } class="bg-white h-8 w-8 mt-3 focus:outline-none flex justify-center items-center border-2 text-gray-900 { tool.name == 'brush' && 'border-green-400' }">
    <svg class="fill-current w-5 h-5 { tool.name != 'brush' && 'opacity-50' }" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M120 0H100V20H120V0Z" />
      <path d="M140 0H120V20H140V0Z" />
      <path d="M100 20H80V40H100V20Z" />
      <path d="M120 20H100V40H120V20Z" />
      <path d="M140 20H120V40H140V20Z" />
      <path d="M80 40H60V60H80V40Z" />
      <path d="M100 40H80V60H100V40Z" />
      <path d="M120 40H100V60H120V40Z" />
      <path d="M60 60H40V80H60V60Z" />
      <path d="M80 60H60V80H80V60Z" />
      <path d="M100 60H80V80H100V60Z" />
      <path d="M60 80H40V100H60V80Z" />
      <path d="M80 80H60V100H80V80Z" />
      <path d="M20 100H0V120H20V100Z" />
      <path d="M40 100H20V120H40V100Z" />
      <path d="M20 120H0V140H20V120Z" fill="{ $project.color }" />
      <path d="M40 120H20V140H40V120Z" />
    </svg>
