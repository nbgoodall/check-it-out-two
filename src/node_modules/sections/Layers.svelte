<script>
  ...
  $: activeLayerIds = $project.currentFrame.activeLayerIds
  ...
  function sortLayers(evt) {
    ...
    $project.currentFrame.sortLayerIds(oldIndex, newIndex)
  ...
  const hoverLayer = (layerId, hover) => evt => {
    $store.hoveringId = hover ? layerId : null
  }
      ...
      >
        <div
          class="
            ...
            { $store.hoveringId === layerId && 'border-green-300' }
