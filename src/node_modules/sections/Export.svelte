<script>
  ...
  function setGifQuality(evt) {
    return $project.setGifQuality(evt.target.value)
  }
...
<div class="bg-white w-full max-h-full max-w-xl p-8 pointer-events-auto">
  ...
  <div class="flex bg-gray-100 p-3 mt-px">
    <div class="flex flex-col">
      <small class="leading-none uppercase text-gray-600 text-xs">Quality</small>

      <input type="number" min="1" max="11" step="1" bind:value={ $project.gifQuality } on:change={ setGifQuality } class="text-2xl text-gray-700 w-auto appearance-none border-0 bg-transparent focus:outline-none">
    </div>
